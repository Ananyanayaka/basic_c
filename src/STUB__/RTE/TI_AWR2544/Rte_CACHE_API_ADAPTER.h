/******************************************************************************
 ** File: Rte_CACHE_API_ADAPTER.h
 ** Role: Header File containing the definition for the SWC: CACHE_API_ADAPTER
...
*******************************************************************************/
#ifndef RTE_CACHE_API_ADAPTER_H
#define RTE_CACHE_API_ADAPTER_H
...
/* Inclusions ================================================================*/
#include "Rte_CACHE_API_ADAPTER_Type.h"        /* Applications Types Header File. Traceability [rte_sws_7131]*/
...
typedef CONSTP2CONST(Rte_CDS_CACHE_API_ADAPTER, AUTOMATIC, RTE_CONST) Rte_Instance;
/* [SWS_Rte_03793] */
extern Rte_Instance Rte_Inst_CACHE_API_ADAPTER;
...
#define RTE_E_CSI_CACHE_API_E_NOT_OK 1U

/* Runnable Entity Prototypes ======================================================*/
/** Traceability [SWS_Rte_01126][rte_sws_6713][rte_sws_1132][rte_sws_1274][rte_sws_7194] */
#define RTE_RUNNABLE_Cache_Invalidate Cache_Invalidate
#define CACHE_API_ADAPTER_START_SEC_CODE
#include "CACHE_API_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, CACHE_API_ADAPTER_CODE) Cache_Invalidate (VAR(dtRef_const_VOID, AUTOMATIC), VAR(uint32, AUTOMATIC));
#define CACHE_API_ADAPTER_STOP_SEC_CODE
#include "CACHE_API_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_Cache_WriteBack Cache_WriteBack
#define CACHE_API_ADAPTER_START_SEC_CODE
#include "CACHE_API_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, CACHE_API_ADAPTER_CODE) Cache_WriteBack (VAR(dtRef_const_VOID, AUTOMATIC), VAR(uint32, AUTOMATIC));
#define CACHE_API_ADAPTER_STOP_SEC_CODE
#include "CACHE_API_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_Cache_WriteBackAndInvalidate Cache_WriteBackAndInvalidate
#define CACHE_API_ADAPTER_START_SEC_CODE
#include "CACHE_API_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, CACHE_API_ADAPTER_CODE) Cache_WriteBackAndInvalidate (VAR(dtRef_const_VOID, AUTOMATIC), VAR(uint32, AUTOMATIC));
#define CACHE_API_ADAPTER_STOP_SEC_CODE
#include "CACHE_API_ADAPTER_MemMap.h"
...
#endif /* RTE_CACHE_API_ADAPTER_H */

/* End of File Rte_CACHE_API_ADAPTER.h========================================*/
