/******************************************************************************
 ** File: Rte_DMA_ADAPTER.h
 ** Role: Header File containing the definition for the SWC: DMA_ADAPTER
...
*******************************************************************************/
#ifndef RTE_DMA_ADAPTER_H
#define RTE_DMA_ADAPTER_H
...
/* Inclusions ================================================================*/
#include "Rte_DMA_ADAPTER_Type.h"        /* Applications Types Header File. Traceability [rte_sws_7131]*/
...
typedef CONSTP2CONST(Rte_CDS_DMA_ADAPTER, AUTOMATIC, RTE_CONST) Rte_Instance;
/* [SWS_Rte_03793] */
extern Rte_Instance Rte_Inst_DMA_ADAPTER;
...
#define RTE_E_CSI_DMA_E_DMA_DRIVER_ERROR 1U

/* Runnable Entity Prototypes ======================================================*/
/** Traceability [SWS_Rte_01126][rte_sws_6713][rte_sws_1132][rte_sws_1274][rte_sws_7194] */
#define RTE_RUNNABLE_Dma_Init Dma_Init
#define DMA_ADAPTER_START_SEC_CODE
#include "DMA_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, DMA_ADAPTER_CODE) Dma_Init (VAR(uint8, AUTOMATIC));
#define DMA_ADAPTER_STOP_SEC_CODE
#include "DMA_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_Dma_MemCpy Dma_MemCpy
#define DMA_ADAPTER_START_SEC_CODE
#include "DMA_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, DMA_ADAPTER_CODE) Dma_MemCpy (P2CONST(Dma_Transfer, AUTOMATIC, DMA_ADAPTER_APPL_CONST), P2CONST(Dma_Config, AUTOMATIC, DMA_ADAPTER_APPL_CONST));
#define DMA_ADAPTER_STOP_SEC_CODE
#include "DMA_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_Dma_ShutDown Dma_ShutDown
#define DMA_ADAPTER_START_SEC_CODE
#include "DMA_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, DMA_ADAPTER_CODE) Dma_ShutDown (void);
#define DMA_ADAPTER_STOP_SEC_CODE
#include "DMA_ADAPTER_MemMap.h"
...
#endif /* RTE_DMA_ADAPTER_H */

/* End of File Rte_DMA_ADAPTER.h==============================================*/
