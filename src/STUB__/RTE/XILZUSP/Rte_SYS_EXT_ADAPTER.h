...
#define RTE_RUNNABLE_SysExt_FPU_FailureExceptionReaction SysExt_FPU_FailureExceptionReaction
#define SYS_EXT_ADAPTER_START_SEC_CODE
#include "SYS_EXT_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_EXT_ADAPTER_CODE) SysExt_FPU_FailureExceptionReaction (VAR(boolean, AUTOMATIC), P2VAR(boolean, AUTOMATIC, SYS_EXT_ADAPTER_APPL_DATA));
...
#define RTE_RUNNABLE_SysExt_StoreCurrentStateToPMU SysExt_StoreCurrentStateToPMU
#define SYS_EXT_ADAPTER_START_SEC_CODE
#include "SYS_EXT_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_EXT_ADAPTER_CODE) SysExt_StoreCurrentStateToPMU (VAR(uint32, AUTOMATIC));
#define SYS_EXT_ADAPTER_STOP_SEC_CODE
#include "SYS_EXT_ADAPTER_MemMap.h"
