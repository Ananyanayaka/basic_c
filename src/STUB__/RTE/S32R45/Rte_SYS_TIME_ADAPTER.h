/******************************************************************************
 ** File: Rte_SYS_TIME_ADAPTER.h
 ** Role: Header File containing the definition for the SWC: SYS_TIME_ADAPTER
...
*******************************************************************************/
#ifndef RTE_SYS_TIME_ADAPTER_H
#define RTE_SYS_TIME_ADAPTER_H
...
/* Inclusions ================================================================*/
#include "Rte_SYS_TIME_ADAPTER_Type.h"        /* Applications Types Header File. Traceability [rte_sws_7131]*/
...
typedef CONSTP2CONST(Rte_CDS_SYS_TIME_ADAPTER, AUTOMATIC, RTE_CONST) Rte_Instance;
/* [SWS_Rte_03793] */
extern Rte_Instance Rte_Inst_SYS_TIME_ADAPTER;
...
#define RTE_E_CSI_SYS_TIME_RTE_E_NOT_OK 1U

/* Runnable Entity Prototypes ======================================================*/
/** Traceability [SWS_Rte_01126][rte_sws_6713][rte_sws_1132][rte_sws_1274][rte_sws_7194] */
#define RTE_RUNNABLE_SysTime_GetHwCounterInTicks SysTime_GetHwCounterInTicks
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_GetHwCounterInTicks (P2VAR(uint32, AUTOMATIC, SYS_TIME_ADAPTER_APPL_DATA));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_GetTimeInTicks SysTime_GetTimeInTicks
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_GetTimeInTicks (P2VAR(uint64, AUTOMATIC, SYS_TIME_ADAPTER_APPL_DATA));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_GetTime_us SysTime_GetTime_us
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_GetTime_us (P2VAR(uint64, AUTOMATIC, SYS_TIME_ADAPTER_APPL_DATA));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_GetTimeSinceBoot_ms SysTime_GetTimeSinceBoot_ms
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_GetTimeSinceBoot_ms (P2VAR(uint32, AUTOMATIC, SYS_TIME_ADAPTER_APPL_DATA));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_GetTimeSince_ms SysTime_GetTimeSince_ms
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_GetTimeSince_ms (VAR(uint32, AUTOMATIC), P2VAR(uint32, AUTOMATIC, SYS_TIME_ADAPTER_APPL_DATA));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_GetTimeSince_us SysTime_GetTimeSince_us
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_GetTimeSince_us (VAR(uint32, AUTOMATIC), P2VAR(uint32, AUTOMATIC, SYS_TIME_ADAPTER_APPL_DATA));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_TimeDelay SysTime_TimeDelay
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(Std_ReturnType, SYS_TIME_ADAPTER_CODE) SysTime_TimeDelay (VAR(uint32, AUTOMATIC));
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"

#define RTE_RUNNABLE_SysTime_TimeInit SysTime_TimeInit
#define SYS_TIME_ADAPTER_START_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
FUNC(void, SYS_TIME_ADAPTER_CODE) SysTime_TimeInit (void);
#define SYS_TIME_ADAPTER_STOP_SEC_CODE
#include "SYS_TIME_ADAPTER_MemMap.h"
...
#endif /* RTE_SYS_TIME_ADAPTER_H */

/* End of File Rte_SYS_TIME_ADAPTER.h=========================================*/
